...
This project is intended for academic use as a BE final year project.
...
> “The system uses CNN and LSTM for offline violence detection, GenAI for post-detection explanation, JWT for secure access, and role-based dashboards for monitoring, making it practical, explainable, and CPU-friendly.”
